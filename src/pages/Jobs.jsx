        ...
        <div className="container mt-4">
          {loading ? (
            <div className="text-center">
              <Spinner animation="border" style={{ marginTop: "140px" }} />
              <p>Loading</p>
            </div>
          ) : (
              ...
              <p>
                {
                  jobs
                    ...
                    .filter((job) => (showSavedOnly ? savedJobs.has(job.id) : true)).length
                }{" "}
                results
              </p>
              <div className="row">
                {jobs
                  ...
                  .filter((job) => (showSavedOnly ? savedJobs.has(job.id) : true))
                  .map((job) => (
                    <div key={job.id} className="col-md-6 mb-3">
                      <Card className={`h-100 d-flex flex-column ${styles.animatedCard}`}>
                        <Card.Body className={`d-flex flex-column ${styles.cardBody}`}>
                          ...
                          <p>
                            <FaMoneyBillAlt className={styles.icon} /> {job.salary}
                          </p>
                          <p>
                        ...
                        <Card.Footer className="d-flex justify-content-between">
                          ...
                          >
                            <FaBookmark
                              className={
                                savedJobs.has(job.id) ? "text-primary" : "text-muted"
                              }
                            />
          ...
          {selectedJob && (
            <Modal show={true} onHide={() => setSelectedJob(null)} className={styles.modal} centered>
