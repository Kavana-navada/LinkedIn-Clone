  ...
  return (
    <>
                  ...
                  {userPosts.length > 0 ? (
                    userPosts.map((post) => (
                      <Col lg={6} className="mb-3" key={post.id}>
                        <Card>
                          <Card.Body>
                            <div style={{ color: "#00000099", fontSize:"14px",marginBottom:"5px" }}>
                            ...
                            <p className="mt-2">Likes: {post.likes}</p>
                          </Card.Body>
                        </Card>
                      </Col>
                    ))
                    ...
                    <p style={{ color: "#00000099" }}>Posts you share will be displayed here.</p>
                    </div>
                  )}
                </Row>
              </Card>
      ...
      />
          ...
          {/* Edit Profile Modal */}
          <Modal className={styles.modal} show={showModal} onHide={() => setShowModal(false)}>
            ...
            <Modal.Footer>
              ...
              <Button className={styles.savebtn} variant="primary" onClick={handleSave}>
                Save
              </Button>
            </Modal.Footer>
          </Modal>
